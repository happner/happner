;(function(isBrowser) {
  ...
  MeshClient.prototype.disconnect = function(){
    try{
      if (clientInstance && clientInstance.data) clientInstance.data.disconnect();
    }catch(e){
      ...
      var subscribe = function() {
        ...
        client.data.on( '/mesh/schema/description',
          ...
          function(description) {
            ...
            MeshClient._updateEndpoint(client, endpointName, exchange, event,
              function(err, res) {
                ...
                if (destroy.length > 0) instance.emit('components/destroy', destroy);
                if (create.length > 0) instance.emit('components/create', create);
              }
            )
          },
          ...
          function(e) {
            ...
            instance.emit('components/create', Object.keys(components).map(
              function(name) {
                return {
