...
var guards = ['isTraceEnabled','isDebugEnabled','isInfoEnabled','isWarnEnabled','isErrorEnabled','isFatalEnabled'];
...
function Util(config) {
  ...
  _this.log = function(message, level, component, data){
    ...
    try {
      ...
      if (config.logLevel.indexOf(level) > -1 || config.logComponents.indexOf(component) > -1) {
