...
var $debug = typeof global == 'object' ? (global.$debug = global.$debug || require('debug')('happngin')) : function() {};
$debug('required lib/system/api.js');
...
var Messenger = function (endpoint, exchange, callback){
  ...
  _this.log = (typeof UTILITIES == 'object' && UTILITIES.createLogger)
  ...
  _this.discardMessage = function(address, methodDescription, args, error){
    ...
    _this.log.warn('Message discarded', arguments);
  }
  ...
  _thisprepareMessage = function(address, methodDescription, args){
...
var getLogger = function() {
  ...
  ? UTILITIES.createLogger('MeshApi')
  : {
    $$TRACE: function() {},
    $$DEBUG: function() {},
    info: function(msg, obj) {
      if (obj) return console.info('MeshApi', msg, obj);
      console.info('MeshApi', msg);
    },
    warn: function(msg, obj) {
      if (obj) return console.warn('MeshApi', msg, obj);
      console.info('MeshApi', msg);
    },
    error: function(msg, obj) {
      if (obj) return console.error('MeshApi', msg, obj);
      console.info('MeshApi', msg);
    }
  });
}
...
function MeshClient(host, port, secret, callback) {
  ...
  if (mode == 'browser') {
    if (typeof async === 'undefined') {
      return getScript('../../resources/lib/modules/async/lib/async.js', function(){
