  ...
  return new Promise(function(resolve, reject) {
    ...
    setTimeout(function PendForEmitterSubs() {
      ...
      initialize(_this, cloneOpts, function(e, client) {
        ...
        resolve(); // peding something useful on successful login
...
var initialize = function(instance, opts, callback) {
  ...
  HappnClient.create({"config":{"host":hostname, "port":port, "secret":secret}, "info": opts.info, "Logger": opts.log}, function(e, fbclient){

    if (e) {

      // TODO: type of e determinse login/error or login/deny
