...
var initialize = function(host, port, secret, happn, callback) {
  ...
  new happn.client({"config":{"host":host, "port":port, "secret":secret}}, function(e, fbclient){
    ...
    client.data.get('/mesh/schema*', {}, function(e, response){
      ...
      MeshClient._initializeEndpoints(client, client._mesh.description, happn, client._mesh.config, function(e) {
        if (e) return callback(e);
  ...
  value: function(_this, description, happn, config, callback) {
    ...
    async.eachSeries(Object.keys(config.endpoints), function(endpointName, eachCallback) {
      ...
      new happn.client(endpointConfig, function(e, client){
        ...
        if (e) {
          getLogger().error('failed connection to endpoint \'' + endpointName + '\'', e);
        ...
        client.get('/mesh/schema/description', {}, function(e, response){
          if (e) {
            getLogger().error('failed getting description from endpoint \'' + endpointName + '\'', e);
            return eachCallback(e);
          }
          ...
          client.on('/mesh/schema/description', {}, function(eventData){
            ...
            if (e) getLogger().warn('Unable to subscribe to remote endpoint \''+endpointName+'\' description.', e);
...
Object.defineProperty(MeshClient, '_createExchangeAPILayer', {
  value: function(_this, callback) {
    ...
    async.eachSeries(Object.keys(_this._mesh.endpoints), function(endpointName, eachCallback){
      ...
      new Messenger(_this._mesh.endpoints[endpointName], _this._mesh.exchange, eachCallback);
