...
Messenger.prototype.createRequestors = function(componentNames, callback) {
  ...
  var responseMask = '/mesh/system/responses' +
                     ...
                     '/' + _this.id +
                     '/*';
  this.log.$$TRACE('subscribe START - data.on( %s', responseMask);
    ...
    var subscribe = function() {
      ...
      client.data.on( '/mesh/schema/description',
        ...
        function(description) {
          ...
          var previousDescription = client._mesh.endpoints[endpointName].description
          var previousComponents = Object.keys(previousDescription.components);

          client._mesh.endpoints[endpointName].description = description;
