...
Mesh.prototype._initializeEndpoints = function(callback) {
  ...
  async.eachSeries(Object.keys(config.endpoints), function(endpointName, eachCallback) {
    ...
    new Happn.client(endpointConfig, function(e, client){
      ...
      if (e) {
        _this.log.error('failed connection to endpoint \'' + endpointName + '\'', e);
      ...
      client.get('/mesh/schema/description', {}, function(e, response){
        if (e) {
          _this.log.error('failed getting description from \'' + endpointName + '\'', e);
          return eachCallback(e);
        }

        _this.log.$$DEBUG('got description from \'' + endpointName + '\'');
        ...
        client.on('/mesh/schema/description', {}, function(eventData){
          ...
          if (e) _this.log.warn('Unable to subscribe to remote endpoint \''+endpointName+'\' description.', e);
          ...
          try {
            ...
            _this.log.warn('Malformed describe from mesh \''+endpointName+'\' ignored.', e);
          }
          eachCallback();
        });
      });
