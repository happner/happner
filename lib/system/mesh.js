...
Mesh.prototype.initialize = function(config, callback){
  ...
  this.log = UTILITIES.createLogger('Mesh'); //' + '/' + config.name);
  ...
  this.exchange_DOC = 'https://github.com/FieldServer/happngin/blob/master/docs/exchange.md';
  this.exchange = {};

  this.event_DOC = 'https://github.com/FieldServer/happngin/blob/master/docs/event.md';
  this.event = {};

  this.data_DOC = 'https://github.com/FieldServer/happngin/blob/master/docs/data.md';
  this.data_INFO = 'Same as _mesh.data';
  Object.defineProperty(this, 'data', {
    get: function() {
      return this._mesh.data;
    },
    enumerable: true
  });
...
Mesh.prototype.describe = function(cached){
  if (!this.initializing || this.initialized) return console.error('indescribable!');
