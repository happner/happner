...
function ComponentInstance() {
  ...
  _this.attachRouteTarget = function(meshRoutePath, componentRoutePath, targetMethod){
    this.mesh.data.context.connect.use(meshRoutePath, _this.module.instance[targetMethod].bind(_this.module.instance));
    this.mesh.data.context.connect.use(componentRoutePath, _this.module.instance[targetMethod].bind(_this.module.instance));
  }
            ...
            if (routeTarget == 'static'){
              ...
              if (UTILITIES.node.isArray(routeTarget)){
                routeTarget.map(function(targetMethod){
                  _this.attachRouteTarget(meshRoutePath, componentRoutePath, targetMethod);
                });
              }else{
                _this.attachRouteTarget(meshRoutePath, componentRoutePath, routeTarget);
              }
            }
          } 
      }catch(e){
