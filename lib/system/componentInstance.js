...
function ComponentInstance() {
  ...
  _this._loadModule = function(module){
    ...
    _this.operate = function(method, parameters, callback){
      try{
        ...
        /* POSSIBLY CALLING TO HAPPNGIN PROXY FUNCTION IF $happen IN ARGS */
        if (methodDefn.$originalFn) {
          methodDefn.call(_this.module.instance, _this, parameters);
        } else {
  ...
  _this._defaultParameters = function(method, methodSchema) {
    if (!methodSchema.parameters) methodSchema.parameters = [];
                                          // possibly proxied function for $happn inject
    UTILITIES.getFunctionParameters(method.$originalFn || method)
    ...
    if (targetMethod == 'static'){
      ...
      if (methodDefn.$originalFn) {
        var proxyFn = function() {
          methodDefn.call(context, _this, Array.prototype.slice.call(arguments));
        }
