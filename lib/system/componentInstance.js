...
ComponentInstance.prototype.initialize = function(root, module, config, callback){
  var defaults;
  ...
  var mesh = root.nodes[config.meshName]._mesh;
...
ComponentInstance.prototype._attach = function(config, callback){
  ...
  this.data.on(subscribeMask, {event_type:'set'}, function(publication){
      ...
      _this.operate(method, args, function(e, responseArguments){
        ...
        _this.data.set(message.callbackAddress, response, _this.config.setOptions, function(e){
          if (e)
