...
ComponentInstance.prototype.attachRouteTarget = function(meshRoutePath, componentRoutePath, targetMethod, route){
  ...
  console.log('attaching client');
  console.log(meshRoutePath,componentRoutePath,targetMethod);

  this.data.context.connect.use(meshRoutePath, methodDefn);
  this.data.context.connect.use(componentRoutePath, methodDefn);
