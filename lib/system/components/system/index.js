...
function System() {
	...
	_this.initialize = function($happn){
		$happn.log.info("system component loaded, local dashboard is here: http://localhost:"+$happn.config.meshPort+"/"+$happn.config.meshName+"/system/app/dashboard.html");
	}
