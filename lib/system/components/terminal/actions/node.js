...
module.exports = function(opts, callback) {
  ...
  callback(null, {
    ...
    run: function(args, done) {
      ...
      r.context.localnode = opts.$happn;
      ...
      // var history = [];
      // Object.defineProperty(r.context.$result, 'history', {
      //   get: function() {
      //     return history;
      //   }
      // })
      ...
      r.context.$callback.README = function() {
        ...
        localnode.name       // **this** mesh component
        localnode.exchange.* // access to other component.functions
                             //    or: endpoint.component.functions (remote)
                             //
        localnode.emit()     // makes you breakfast
        localnode.event.*    // .kitchen.oven.on() and .kitchen.oven.off()
                             // (   does not turn the oven on and off    ) 
                             //       it subscribes and unsubscribes
                             //
        localnode.data.*     // access datalayer
                             //
        ...
        __node> localnode.exchange.terminal.register('hello', {}, $callback)
        ...
        __node> $callback.stack.tags    // tagged history


        To use the tags:

        __node> t = localnode.exchange.terminal
