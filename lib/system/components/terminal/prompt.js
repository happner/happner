...
var historyFile = process.env.HOME + '/.happner.termhistory.txt';
var historyCursor = 0;
var latestCommand = '';
var keyListener;
...
module.exports.start = function(commands) {
  ...
  Object.keys(commands).map(function(name) {
    ...
    if (typeof action == 'function') {
      action = action({prompt: module.exports});
    }
  ...
  module.exports.setStreams(process.stdin, console._stdout, true, true, true);

}

module.exports.registerCommand = function(name, action) {
