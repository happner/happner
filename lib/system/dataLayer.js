...
module.exports.create = function(mesh, config, callback) {
  ...
  if (config.datalayer.filename)
    config.datalayer.persist = true;
  ...
  if (config.datalayer.sessionTokenSecret)
    config.datalayer.sessionTokenSecret = config.datalayer.sessionTokenSecret;
  else
  ...
  if (config.datalayer.persist) {
    ...
    try {
      ...
      if (!config.datalayer.defaultRoute)
        config.datalayer.defaultRoute = "mem";
