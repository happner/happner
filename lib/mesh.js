...
Mesh.prototype.initialize = Promise.promisify(function(config, callback){
  ...
  var beforeDatalayer = Date.now();

  //we first need the datalayer up, with a name
  _this._initializeDataLayer(config, function(e){

    console.log('startuptimes:::_initializeDataLayer:', Date.now() - beforeDatalayer);
    ...
    configer.process(_this, config, function(e, config) {
      ...
      */
      var beforeRepl = Date.now();

      repl.create(_this);

      console.log('startuptimes:::repl.create:', Date.now() - beforeRepl);
      ...
      console.log('startuptimes:::attachSystemComponents:', Date.now() - started);
      ...
      async.series([
        ...
        function(callback) {
          ...
          console.log('startuptimes:::getPackagedModules:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::loadPackagedModules:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_loadComponentSuites:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_registerInitialSchema:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_initializePackager:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_initializeLocal:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_initializeElements:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_registerSchema:', Date.now() - started);
        ...
        function(callback) {
          ...
          console.log('startuptimes:::_initializeEndpoints:', Date.now() - started);
        ...
        console.log('startuptimes:::total:', Date.now() - beforeDatalayer);
