...
Mesh.prototype.initialize = Promise.promisify(function(config, callback){
  ...
  configer.process(this, config, function(e, config) {
    ...
    async.series([
      ...
      function(callback) {
        _this.attachPackagedModules(config, callback);
      },
      function(callback) {
...
Mesh.prototype._createModule = function(spec, callback) {
  ...
  if (moduleConfig.packaged)
    spec.module.packaged = this._mesh.config.packaged[moduleConfig.packaged];
  ...
  UTILITIES.findFiles(
   ...
   function(e, matches){
      ...
      matches.map(function(match){
        ...
        config.packaged[happnerConfig.id] = happnerConfig;
...
Mesh.prototype.attachPackagedModules = function(config, callback){
