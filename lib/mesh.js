    ...
    async.series([
      ...
      function(callback) {
        _this.log.$$DEBUG('initialized data layer');
                                  ...
                                  // none has been set yet been set by this newly started node.
                                 //
...
Mesh.prototype._createElement = function(spec, writeSchema, callback) {
  var _this = this;
  ...
  this.log.$$DEBUG('creating element with component \'%s\' on module \'%s\'', spec.component.name, spec.module.name);
  async.series([
    function(done) {
...
Mesh.prototype._eachComponent = function(flow, operator, callback){
  var _this = this;
  async[flow](
    Object.keys(this._mesh.elements).map(function(componentName) {
      return function(done) {
