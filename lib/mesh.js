    ...
    function(e, matches){
      ...
      matches.map(function(match){
        ...
        happnerConfig.configs.autoload.forEach(function(elementConfig) {
          ...
          // --------------------------------------------------------------------------
          // following does nothing, should be `elementConfig.module.config.path` if it 
          // wanted to do something...
          //
          // and it's a bad idea to force a path
          // also, path can contain '<path>.ClassName'
          // so that's a spanner too
          // --------------------------------------------------------------------------
          // 
