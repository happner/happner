...
var __newMesh = function(config, meshContext){

  return {
    __context:meshContext,
    ...
    _createElement: function (spec, writeSchema, callback) {
      this.__context._createElement(spec, writeSchema, callback);
    },

    _destroyElement: function (componentName, callback) {
      this.__context._destroyElement(componentName, callback);
    }
...
function Mesh(config) {
  ...
  this._mesh = __newMesh(config, _this);
...
Mesh.prototype.__initialize = function (config, callback) {
  ...
  if (_this._mesh.stopped) {
    ...
    _this._mesh = __newMesh(config, _this);
  }
