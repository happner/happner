  ...
  UTILITIES.findInModules('happner.js', module.paths,
    function(e, matches){
      ...
      var promise = Promise.map(matches, function(match) {
        ...
        var ammendSuites = function(suite) {
        ...
        if (typeof happnerConfig.configs.autoload == 'function') {
          return happnerConfig.configs.autoload(config).then(function(suite) {
            return ammendSuites(suite);
          });
        }

        return ammendSuites(happnerConfig.configs.autoload);
