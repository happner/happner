...
Mesh.prototype.describe = function(cached){
  ...
  for (var componentName in this._mesh.elements){
    description.components[componentName] = this._mesh.elements[componentName].component.instance.describe();
  }
...
Mesh.prototype._createElement = function(spec, callback) {
  var _this = this;
...
Mesh.prototype._createModule = function(spec, callback) {
  ...
  try {
    ...
    if (ignore) {
      this.log.info('missing or null module \'%s\'', ignore);
      return callback();
    } else {
