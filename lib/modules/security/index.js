...
function Security() {
	...
	*/
	...
	_this.addGroup = function($happn, group, callback){
		...
		this.__validateRequest('addGroup', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.upsertGroup(_transformMeshPermissions($happn, group), {overwrite:false}, callback);
		});
	...
	_this.updateGroup = function($happn, group, callback){
		...
		this.__validateRequest('updateGroup', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.upsertGroup(_transformMeshPermissions($happn, group), callback);
		});
	...
	_this.addUser = function($happn, user, callback){
		...
		this.__validateRequest('addUser', arguments, function(e){
			if (e) return callback(e);
	...
	_this.updateUser = function($happn, user, callback){
		...
		this.__validateRequest('updateUser', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.upsertUser(user, callback);
		});
	};
	...
	_this.linkGroup = function($happn, group, user, callback){
		...
		this.__validateRequest('linkGroup', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.linkGroup(group, user, {}, callback);
	...
	_this.listGroups = function($happn, groupName, callback){
		...
		this.__validateRequest('listGroups', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.listGroups(groupName, {}, callback);
		});
	};
	...
	_this.listUsers = function($happn, userName, callback){
		this.__validateRequest('listUsers', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.listUsers(userName, {}, callback);
		});
	};
	...
	_this.getUser = function($happn, userName, callback){
		this.__validateRequest('getUser', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.getUser(userName, {}, callback);
		});
	}

	_this.getGroup = function($happn, groupName, callback){
		this.__validateRequest('getGroup', arguments, function(e){
			if (e) return callback(e);
			this.__securityService.getGroup(groupName, {}, callback);
		});
	}

	_this.deleteGroup = function(group, callback){
		this.__validateRequest('deleteGroup', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.deleteGroup(group, {}, callback);
		});
	}

	_this.deleteUser = function(user, callback) {
		this.__validateRequest('deleteUser', arguments, function(e){
			if (e) return callback(e);
			_this.__securityService.deleteUser(user, {}, callback);
		});
	}
