...
function Security() {
	...
	Security.prototype.initialize = function($happn, callback){
		...
		try{
			...
			_this.__createUsersAndGroups($happn, function(e){

				_this.__securityService.onDataChanged(function(whatHappnd, changedData){
					_this.securityDirectoryChanged($happn, whatHappnd, changedData);
				});
	...
	Security.prototype.securityDirectoryChanged = function($happn, whatHappnd, changedData){
